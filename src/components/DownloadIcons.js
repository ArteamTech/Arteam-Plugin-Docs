...
export function LoadingSpinnerIcon() {
  return (
    <svg className="spinnerSvg" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
      <circle 
...
// 不可用文件图标
export function NoFilesIcon(props) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
...
// 稳定版本图标
export function StableIcon(props) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
...
// 全部版本图标
export function AllVersionsIcon(props) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
